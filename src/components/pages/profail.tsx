...
const Profail: React.FC = () => {
  return (
    <div className="p-6 bg-white rounded-lg shadow-md flex flex-row gap-4 m-4 ">
      <div className="flex flex-col  w-2/3 gap-4 leading-7 pl-4 m-auto">
        <h1 className="flex text-3xl font-semibold w-90 ">Hi, I'm Ridwaan Hassan Creative Technologiest</h1>
